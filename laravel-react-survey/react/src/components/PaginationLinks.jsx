        ...
        <div>
          <nav aria-label="Pagination" className="isolate inline-flex -space-x-px rounded-md shadow-sm">
            ...
            {meta.links &&meta.links.map((link, ind) => (
                ...
                aria-current="page"
                className={
                    "relative z-10 inline-flex items-center bg-indigo-600 px-4 py-2 text-sm font-semibold text-white focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600" + (ind === 0 ? " rounded-l-md" : "") 
                    + (link.active ? 'border-indigo-500 text-indigo-600 bg indigo-50 '  : 'border-gray-300 text-gray-500')
